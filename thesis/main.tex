...
\newcommand{\getcmdline}[4]
{\begingroup
\cmdlstsettings{#2}{#3}{#4}
\begin{cmdframe}
\lstinputlisting{#1}
\end{cmdframe}
\endgroup}

\newcommand{\dpd}[1]{\noindent \textbf{Dependencies:} #1}
...
\input chapters/chapter0/chapter0.tex
