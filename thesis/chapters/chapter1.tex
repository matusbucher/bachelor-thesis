...
The recent use of reverse shell has been observed in cyber operations related to the Russia-Ukraine conflict since October 2023 \cite{cluster25}. This phishing-based attack exploited a vulnerability in the WinRAR software identified as CVE-2023-38831 \cite{cve2023-38831}. The lure file was a PDF document masquerading itself as a file to share Indicators of Compromise.
