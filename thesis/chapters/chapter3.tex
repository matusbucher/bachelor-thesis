...
\getcmdline{\commandpath{pwsh-runscript.txt}}{bash}{*}{pwsh}{}{Running the PowerShell reverse shell script}{pwsh-runscript}
...
\getcmdline{\commandpath{python-runscript.txt}}{bash}{*}{python}{}{Running the Python reverse shell script}{python-runscript}
...
\getcmdline{\commandpath{perl-runscript.txt}}{bash}{*}{perl}{}{Running the Perl reverse shell script}{perl-runscript}
...
\getcmdline{\commandpath{php-runscript.txt}}{bash}{*}{php}{}{Running the PHP reverse shell script}{php-runscript}
...
\getcmdline{\commandpath{lua-runscript.txt}}{bash}{*}{lua}{}{Running the Lua reverse shell script}{lua-runscript}
...
\getcmdline{\commandpath{ruby-runscript.txt}}{bash}{*}{ruby}{}{Running the Ruby reverse shell script}{ruby-runscript}
...
\getcmdline{\commandpath{node-runscript.txt}}{bash}{*}{node}{}{Running the Node.js reverse shell script}{node-runscript}
...
\getcmdline{\commandpath{julia-runscript.txt}}{bash}{*}{julia}{}{Running the Julia reverse shell script}{julia-runscript}
...
\getcmdline{\commandpath{java-code.txt}}{Java}{*}{}{}{Java reverse shell code}{java-code}

\TODO{dependencies}

\getcmdline{\commandpath{java-runcode.txt}}{bash}{*}{javac}{}{Compiling and running the Java reverse shell code}{java-runcode}
...
\getcmdline{\commandpath{go-runcode.txt}}{bash}{*}{go}{}{Compiling and running the Go reverse shell code}{go-runcode}
...
\getcmdline{\commandpath{gawk-script.txt}}{awk}{*}{}{}{Gawk reverse shell script}{gawk-script}
...
\getcmdline{\commandpath{gawk-runscript.txt}}{bash}{*}{gawk}{}{Running the Gawk reverse shell script}{gawk-runscript}

\getcmdline{\commandpath{gawk-oneline.txt}}{bash}{*}{gawk}{}{Gawk one-line reverse}{gawk-oneline}
