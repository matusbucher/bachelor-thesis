...
\dpd{dependencies from \cref{code:python-script}, additional Python modules and loadable objects (see \cref{tab:pip-mod} and \cref{tab:pip-lib} in the appendix A)}
}
